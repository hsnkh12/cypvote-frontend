...
export default function CandidateDetail(props) {
    ...
    const fetchCandidate = async () => {
        ...
        try {
            ...
            const res = await axios.get("http://localhost:8080/candidates/" + candidate_id, {
                headers: {
    ...
    const fetchElections = async () => {
        try {
            ...
            const res = await axios.get("http://localhost:8080/elections/candidate-involved/" + candidate_id, {
                headers: {
                    Authorization: 'Bearer ' + token
                }
            })
